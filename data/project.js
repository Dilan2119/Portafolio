const projects = [
  {
    ...
    icons: [
      "iconos/iconohtml.svg",
      "iconos/iconocss.svg",
      "iconos/iconosjs.svg",
      "iconos/iconossql.svg",
      "iconos/iconosass.svg",
      "iconos/iconophp.svg",
      "iconos/iconogit.svg",
    ],
  },
  ...
  },
  {
    ...
    title: "Dental Clinic",
    description:
      "es una clínica dental que ofrece servicios como odontología cosmética, alineamiento dental, terapias de conducto, inspección de cavidades y asesoramiento dental. También cuentan con áreas especializadas en cosmética dental, pediatría e implantes dentales",
    technologies: ["HTML", "CSS", "JavaScript", "Git"],
    icons: [
      "iconos/iconohtml.svg",
      "iconos/iconocss.svg",
      "iconos/iconosjs.svg",
      "iconos/iconoboot.svg",
      "iconos/iconossql.svg",
    ],
  },
  {
 ...
 
  {
    ...
    description:
      "Es un juego interactivo en línea donde el jugador intenta adivinar un número secreto generado aleatoriamente por el sistema. El juego proporciona pistas sobre si el número es mayor o menor hasta que el jugador adivina correctamente.",
